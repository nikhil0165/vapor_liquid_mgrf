...
psi_complete,nconc_complete,uself_complete, q_complete, z, res= num_concn.nconc_complete(psi_complete,nconc_complete,n_bulk1,n_bulk2,valency,rad_ions,vol_ions,vol_sol,domain,epsilon_s,equal_vols = True)
print('MGRF_done')
...
file_name = str(round(T_star, 5)) + '_' + str(round(float(domain), 2)) + '_' + str(round(rad_ions_d[0] / pow(10, -10), 2)) + '_' + str(round(rad_ions_d[1] / pow(10, -10), 2))
